...
const T = {
  ...
  es: {
    ...
    cats: {
      ...
      formation:     'Formación',
      cursos:        'Cursos',
      cuota_hija:    'Cuota hija',
      kids_activities: 'Actividades niños',
      kids_support:     'Soporte niños',
      kids_wishlist:    'Wishlist niños',
      donations:     'Donaciones',
      credit_card_fees: 'Comisiones tarjeta',
  ...
  en: {
    ...
    cats: {
      ...
      other_income:'Other income', food:'Food', groceries:'Groceries', housing:'Housing',
      ...
      donations:'Donations', credit_card_fees:'Credit card fees', other_expense:'Other expense', emergency:'Emergency',
      vacation:'Vacation', retirement:'Retirement', goal:'Goal', formation:'Formation', kids_activities:'Kids activities', kids_support:'Kids support', kids_wishlist:'Kids wishlist',
      transfer:'Transfer', dons: 'Dons', debts: 'Debts', credit_card_payment: 'Credit card payment',
      travel:'Travel', subscription:'Subscription', gift:'Gift', formation:'Formation', cursos:'Courses', cuota_hija:'Child support quota', transfer_to_saving:'Transfer to saving',
    },
  },
  ...
  fr: {
    ...
    cats: {
      ...
      other_income:'Autre revenu', food:'Alimentation', groceries:'Épicerie', housing:'Logement',
      ...
      donations:'Dons', credit_card_fees:'Frais carte de crédit', other_expense:'Autre dépense', emergency:'Urgences',
      vacation:'Vacances', retirement:'Retraite', goal:'Objectif', formation:'Formation', kids_activities:'Activités enfants', kids_support:'Soutien enfants', kids_wishlist:'Wishlist enfants',
      transfer:'Transfert', dons: 'Dons', debts: 'Dettes', credit_card_payment: 'Paiement carte',
      travel:'Voyage', subscription:'Abonnement', gift:'Cadeau', formation:'Formation', cursos:'Cours', cuota_hija:'Pension enfant', transfer_to_saving:'Transfert vers épargne',
    },
  },
}
